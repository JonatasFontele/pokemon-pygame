...
class Haunter(model.pokemon.Pokemon):
    def __init__(self):
        ...
        self.animation_list.append(self.image.get_image(470, 0, 65, 45, 2, light_blue))
        self.animation_list.append(self.image.get_image(402, 0, 68, 50, 2, light_blue))
        self.animation_list.append(self.image.get_image(335, 0, 65, 45, 2, light_blue))

        # Second row right — Forward
        self.animation_list.append(self.image.get_image(470, 50, 65, 50, 2, light_blue))
        self.animation_list.append(self.image.get_image(405, 50, 65, 50, 2, light_blue))
        self.animation_list.append(self.image.get_image(340, 50, 65, 50, 2, light_blue))
